Player=game:GetService("Players"):FindFirstChild(string.sub(script.Name, 4))
...
local abc = script.LocalScript:Clone()
...
S.BlastRadius = 500
S.ExplosionType = 2
S.Hit:connect(function(Part, Distance)
Part.Anchored = false
...
script.click.OnServerEvent:connect(function()
ALLAHUAKBAR()
end)
